                        ...
                        <div className=' sect3'>
                            <div className='row justify-content-center' style={{ margin: "30px 10px 30px 10px" }}>
                                <div className='col-sm-12'>
                                    <span className='Schedule'>Schedule your col-smlection in New York City <img className='img-fluid' src={ arrow} /></span>
                                </div>
                                <div className='row justify-content-center '>
                                    <div className='col-sm-4 setion3'>
                                    ...
                                    <button className='btn btn4 col-sm-3'>Search your slots</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
// <section className='ddd' >
// <div className='container-fluid  '   >
//     <div className='row justify-content-center sect3'>
